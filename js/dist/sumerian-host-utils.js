...
async function loadAssets(
  ...
  //console.log("fiona", characterAsset);
...
function addTextToSpeech(host, scene, voice, engine, audioJointName = 'mixamorig2:Neck'/*'char:def_c_neckB'*/) {
  const joints = host.owner.getDescendants(false);
  //console.log("joints", joints);
  const audioJoint = joints.find((joint) => joint.name === audioJointName);
  //console.log("joint", audioJoint);
...
characterTypeMap.forEach((characterType, characterId) => {
  const characterConfig = {
    ...
    gestureConfigUrl: `assets/3d-assets/animations/${characterType}/gesture.json`,
    pointOfInterestConfigUrl: `assets/3d-assets/animations/${characterType}/poi.json`,
    animStandIdleUrl: `assets/3d-assets/animations/${characterType}/stand_idle.glb`,
    animLipSyncUrl: `assets/3d-assets/animations/${characterType}/lipsync.glb`,
    animGestureUrl: `assets/3d-assets/animations/${characterType}/gesture.glb`,
    animEmoteUrl: `assets/3d-assets/animations/${characterType}/emote.glb`,
    animFaceIdleUrl: `assets/3d-assets/animations/${characterType}/face_idle.glb`,
    animBlinkUrl: `assets/3d-assets/animations/${characterType}/blink.glb`,
    animPointOfInterestUrl: `assets/3d-assets/animations/${characterType}/poi.glb`,
  };
